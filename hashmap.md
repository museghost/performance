...
```bash
Running ./build-release/build_subfolder/performance/jrm-hashmap_lookup
Run on (2 X 2300.05 MHz CPU s)
CPU Caches:
  L1 Data 32 KiB (x2)
  L1 Instruction 32 KiB (x2)
...
Benchmark                             Time             CPU   Iterations
-----------------------------------------------------------------------
BM_lookup_key_int64_t              2.33 ns         2.33 ns    300031173
BM_lookup_key_bypass_int64_t       2.27 ns         2.27 ns    308329745
BM_lookup_key_std_string           11.6 ns         11.6 ns     60627644
BM_lookup_key_classA               2.06 ns         2.06 ns    340160990
```
